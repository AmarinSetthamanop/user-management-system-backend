...
INSERT INTO "new_User" ("created_at", "created_by", "email", "id", "last_login", "name", "password", "phone_number", "role_id", "updated_at", "updated_by") SELECT "created_at", "created_by", "email", "id", "last_login", "name", "password", "phone_number", "role_id", "updated_at", "updated_by" FROM "User";
DROP TABLE "User";
